...
This is more clearly explained in the [Youtube video tutorial](https://youtu.be/TrvhLP2CyVA), but here is a diagram that shows the process:
...
## Contributing
This repository is meant as supporting material for the [Youtube video tutorial](https://youtu.be/TrvhLP2CyVA). Therefore, I am not accepting any pull requests unless they are for fixing bugs or typos.
